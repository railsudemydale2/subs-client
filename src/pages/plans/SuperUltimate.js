...
const SuperUltimateSubscription = ({ history, match }) => {
    ...
    <Fragment>
      <div className="container-fluid">
        <div className="row py-5 bg-light text-center">
          <h1 className="display-4 fw-bold">SUPERULTIMATE</h1>
          <p className="lead">
            Here are your 75 exclusive stocks of this month
          </p>
        </div>
      </div>
...
export default SuperUltimateSubscription;
